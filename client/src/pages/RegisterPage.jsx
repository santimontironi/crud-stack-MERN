        ...
        <main className="contenedorRegistro w-full h-screen bg-green-400">
            ...
            <div className="flex flex-col gap-5 justify-center items-center mt-20">
                <form className="flex bg-gray-950 flex-col gap-4 p-6 shadow-[8px_8px_12px_black] w-[450px]" method="post" onSubmit={handleSubmit(submitForm)}>
                    <input className="bg-white w-[400px] p-3 focus:shadow-[5px_5px_5px_black]" type="text" {...register("username",{required:true})} placeholder="Username" />
                    <input className="bg-white w-[400px] p-3 focus:shadow-[5px_5px_5px_black]" type="email" {...register("email",{required:true})} placeholder="Correo electrónico" />
                    <input className="bg-white w-[400px] p-3 focus:shadow-[5px_5px_5px_black]" type="password" {...register("password",{required:true})} placeholder="Contraseña" />
